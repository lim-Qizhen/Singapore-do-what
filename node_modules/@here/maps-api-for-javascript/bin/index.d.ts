...
declare namespace H.data.heatmap {
  ...
  class Provider extends H.map.provider.RemoteTileProvider {
    ...
    requestInternal (col : number , row : number , level : number , onResponse : (a : null | HTMLImageElement | HTMLCanvasElement | ArrayBuffer | GlobalObject , b ? : any ) => any , onError : (a : Error | null ) => any , f ? : number ) : H.util.ICancelable | null ;
    /**
...
declare namespace H.map.ViewModel {
  type ILookAtData = { bounds ? : H.geo.AbstractGeometry | null , heading ? : number , incline ? : number , position ? : H.geo.IPoint | null , tilt ? : number , zoom ? : number } ;
}
declare namespace H.map {
  /**
...
declare namespace H.map.provider {
  ...
  class ImageTileProvider extends H.map.provider.RemoteTileProvider {
     ...
     */
    getOpacity ( ) : number ;
    requestInternal (x : number , y : number , z : number , onResponse : (a : null | HTMLImageElement | HTMLCanvasElement | ArrayBuffer | GlobalObject , b ? : any ) => any , onError : (a : Error | null ) => any , priority ? : number ) : H.util.ICancelable | null ;
    /**
...
declare namespace H.map.provider {
  ...
  class LocalObjectProvider extends H.map.provider.ObjectProvider {
    ...
    requestDomMarkers (geoRect : H.geo.Rect | null , zoom : number | undefined , visiblesOnly : boolean , cacheOnly : boolean ) : H.map.DomMarker [] ;
    requestMarkers (geoRect : H.geo.Rect | null , zoom : number | undefined , visiblesOnly : boolean , cacheOnly : boolean ) : H.map.Marker [] ;
    requestOverlays (geoRect : H.geo.Rect | null , zoom : number | undefined , visiblesOnly : boolean , cacheOnly : boolean ) : H.map.Overlay [] ;
    requestSpatials (geoRect : H.geo.Rect | null , zoom : number | undefined , visiblesOnly : boolean , cacheOnly : boolean ) : H.map.Spatial [] ;
  }
}
declare namespace H.map.provider {
  /**
  ...
  class MarkerTileProvider extends H.map.provider.RemoteTileProvider {
     ...
     */
    providesDomMarkers ( ) : boolean ;
    requestInternal (x : number , y : number , z : number , onResponse : (a : null | HTMLImageElement | HTMLCanvasElement | ArrayBuffer | GlobalObject , b ? : any ) => any , onError : (a : Error | null ) => any , f ? : number ) : H.util.ICancelable | null ;
  }
}
...
declare namespace H.map.provider {
  ...
  abstract class ObjectProvider extends H.map.provider.Provider {
     ...
     * @param cacheOnly A value indicating whether only cached objects are to be considered (`true`) or not (`false`)
     */
    abstract requestDomMarkers (geoRect : H.geo.Rect | null , zoomLevel : number | undefined , visiblesOnly : boolean , cacheOnly : boolean ) : H.map.DomMarker [] ;
    /**
     ...
     * @param cacheOnly A value indicating whether only cached objects are to be considered (`true`) or not (`false`)
     */
    abstract requestMarkers (geoRect : H.geo.Rect | null , zoomLevel : number | undefined , visiblesOnly : boolean , cacheOnly : boolean ) : H.map.Marker [] ;
    /**
     ...
     * @param cacheOnly A value indicating whether only cached objects are to be considered (`true`) or not (`false`)
     */
    abstract requestOverlays (geoRect : H.geo.Rect | null , zoomLevel : number | undefined , visiblesOnly : boolean , cacheOnly : boolean ) : H.map.Overlay [] ;
    /**
     ...
     * @param cacheOnly A value indicating whether only cached objects are to be considered (`true`) or not (`false`)
     */
    abstract requestSpatials (geoRect : H.geo.Rect | null , zoomLevel : number | undefined , visiblesOnly : boolean , cacheOnly : boolean ) : H.map.Spatial [] ;
  }
}
declare namespace H.map.provider {
  /**
...
declare namespace H.map.provider.Provider {
  type Options = { engineType ? : H.Map.EngineType , getCopyrights ? : (a : H.geo.Rect | null , b : number ) => any , max ? : number , min ? : number , uri ? : string } ;
}
declare namespace H.map.provider {
  /**
  ...
  abstract class RemoteTileProvider extends H.map.provider.TileProvider {
     ...
     */
    abstract requestInternal (x : number , y : number , z : number , onResponse : (a : null | HTMLImageElement | HTMLCanvasElement | ArrayBuffer | GlobalObject , b ? : any ) => any , onError : (a : Error | null ) => any , opt_priority ? : number ) : H.util.ICancelable | null ;
    requestTile (x : number , y : number , z : number , cacheOnly : boolean ) : H.map.provider.Tile | null | undefined ;
  }
}
declare namespace H.map.provider {
...
declare namespace H.map.provider.TileProvider {
  type Options = { engineType ? : H.Map.EngineType , getCopyrights ? : (a : H.geo.Rect | null , b : number ) => any , max ? : number , min ? : number , tileSize ? : number , uri ? : string } ;
}
...
declare namespace H.service.MapTileService {
  ...
  type Options = { baseUrl ? : H.service.Url | null , headers ? : GlobalObject | null , path ? : string , shards ? : any [] | null , subDomain ? : string , type ? : string , version ? : string } ;
}
declare namespace H.service {
  /**
   * This service is no longer being actively developed.
...
declare namespace H.service {
  ...
  class Platform {
     ...
     * @param opt_options Configuration options of the service
     */
    getCustomRoutingService (opt_options ? : H.service.extension.customLocation.Service.Options ) : H.service.extension.customRoute.Service ;
    /**
     ...
     */
    getPublicTransitService (opt_options ? : H.service.extension.customLocation.Service.Options ) : H.service.publicTransit.Service ;
    /**
...
declare namespace H.service.Platform {
  type DefaultLayersOptions = { crossOrigin ? : string | null , engineType ? : number , lg ? : string , lg2 ? : string , pois ? : boolean , ppi ? : number , style ? : string , tileSize ? : number } ;
...
declare namespace H.service.extension.customLocation {
  ...
  class TileProvider extends H.service.extension.TileProvider {
    ...
    requestInternal (x : number , y : number , z : number , onSuccess : (a : null | HTMLImageElement | HTMLCanvasElement | ArrayBuffer | GlobalObject , b ? : any ) => any , onError : (a : Error | null ) => any , f ? : number ) : H.util.ICancelable | null ;
  }
}
...
declare namespace H.service.iml {
  ...
  class Provider extends H.map.provider.RemoteTileProvider {
     ...
     */
    constructor (service : H.service.iml.Service | null , catalogHrn : string , layerId : string , opt_options ? : H.service.iml.Provider.Options ) ;
    /**
...
declare namespace H.service.iml.Provider {
  type Options = { engineType ? : H.Map.EngineType , max ? : number , min ? : number , parameters ? : GlobalObject | null } ;
}
declare namespace H.service.iml {
  /**
  ...
  class Service extends H.service.Service {
     ...
     */
    deleteFeature (featureId : string , catalogHrn : string , layerId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback function to be called in case of failed request.
     */
    deleteFeatures (featureIds : string [] | null , catalogHrn : string , layerId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     */
    getFeatureById (featureId : string , catalogHrn : string , layerId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback function to be called in case of failed request.
     */
    getFeaturesByBoundingBox (params : GlobalObject | null , catalogHrn : string , layerId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback function to be called in case of failed request.
     */
    getFeaturesByGeometryAndRadius (params : GlobalObject | null , geojsonObject : GlobalObject | null , catalogHrn : string , layerId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     * @param opt_params Optional service parameters to be added to the request.
     */
    getFeaturesById (featureIds : string [] | null , catalogHrn : string , layerId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback function to be called in case of failed request.
     */
    getFeaturesByPointAndRadius (params : GlobalObject | null , catalogHrn : string , layerId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     */
    getFeaturesByTile (x : number , y : number , z : number , catalogHrn : string , layerId : string , onResult : (a : ArrayBuffer | null | GlobalObject ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null , opt_geojsonFormat ? : boolean ) : H.util.ICancelable | null ;
    /**
     ...
     * @param opt_params Optional service parameters to be added to the request.
     */
    getStatistics (catalogHrn : string , layerId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     ...
     * @param opt_params Optional service parameters to be added to the request.
     */
    iterateFeatures (catalogHrn : string , layerId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     ...
     * @param opt_params Optional service parameters to be added to the request.
     */
    patchFeature (featureId : string , geojsonObject : GlobalObject | null , catalogHrn : string , layerId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     ...
     * @param opt_params Optional service parameters to be added to the request.
     */
    postFeatures (geojsonObject : GlobalObject | null , catalogHrn : string , layerId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     ...
     * @param opt_params Optional service parameters to be added to the request.
     */
    putFeature (featureId : string , geojsonObject : GlobalObject | null , catalogHrn : string , layerId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     ...
     * @param opt_params Optional service parameters to be added to the request.
     */
    putFeatures (geojsonObject : GlobalObject | null , catalogHrn : string , layerId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     ...
     * @param opt_params Optional service parameters to be added to the request.
     */
    searchFeatures (catalogHrn : string , layerId : string , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
     * The property name to use when specifying options for this service
     * within the {@link H.service.Platform.Options#servicesConfig}.
     */
...
declare namespace H.service.iml.Service {
  type Options = { baseUrl ? : H.service.Url | null , getToken ? : ( ) => string , headers ? : GlobalObject | null , path ? : string , subDomain ? : string } ;
}
...
declare namespace H.service.omv {
  ...
  class Provider extends H.map.provider.RemoteTileProvider {
    ...
    getStyleInternal ( ) : H.map.render.Style < any > | null ;
    getTileKey (x : number , y : number , z : number ) : string ;
    requestInternal (x : number , y : number , z : number , onResponse : (a : null | HTMLImageElement | HTMLCanvasElement | ArrayBuffer | GlobalObject , b ? : any ) => any , onError : (a : Error | null ) => any , opt_priority ? : number ) : H.util.ICancelable | null ;
    /**
     * Sets the style to be used for rendering the provider data.
     */
    setStyle (style : H.map.render.Style < any > | null ) : void ;
...
declare namespace H.service.omv {
  ...
  class Service extends H.service.Service {
     ...
     */
    getPoliticalViews (onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     * The property name to use when specifying options for this service
     * within the {@link H.service.Platform.Options#servicesConfig}.
     */
...
declare namespace H.service.omv.Service {
  type Options = { baseUrl ? : H.service.Url | null , headers ? : GlobalObject | null , mapVersion ? : string , path ? : string , subDomain ? : string } ;
}
declare namespace H.service.publicTransit {
  ...
  class Service extends H.service.Service {
     ...
     */
    constructor (options : H.service.extension.customLocation.Service.Options ) ;
    /**
...
declare namespace H.service.traffic {
  ...
  class Service extends H.service.Service {
     ...
     */
    createFlowLayer (opt_additionalParameters ? : GlobalObject | null , opt_engineType ? : H.Map.EngineType ) : H.map.layer.TileLayer | null ;
    /**
...
declare namespace H.service.traffic.flow {
  ...
  class Provider extends H.map.provider.RemoteTileProvider {
     ...
     */
    constructor (service : H.service.traffic.Service | null , opt_refreshTime ? : number , opt_additionalParameters ? : GlobalObject | null , opt_engineType ? : H.Map.EngineType ) ;
    protected createTileInternal (x : number , y : number , z : number , data : HTMLImageElement | null | HTMLCanvasElement | GlobalObject , opt_options ? : { [ key: string ]: any } | null ) : H.map.provider.Tile | null ;
    /**
     * To obtain the style used for rendering the provider data.
     */
...
declare namespace H.service.xyz {
  ...
  class Provider extends H.map.provider.RemoteTileProvider {
     ...
     * @param opt_options The configuration options for the provider.
     */
    constructor (service : H.service.xyz.Service | null , spaceId : string , opt_options ? : H.service.iml.Provider.Options ) ;
...
declare namespace H.service.xyz.Service {
  type Options = { baseUrl ? : H.service.Url | null , headers ? : GlobalObject | null , path ? : string , subDomain ? : string , token : string } ;
}
